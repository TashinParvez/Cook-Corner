...
// print_r("Chunk" . $chunk_recipes . "Recipes");
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="row justify-content-center">
                            ...
                            <?php foreach ($chunk_recipes as $chunk_recipe) { ?>

                                <div class="col-md-2">
                                    <div class="card text-white">
                                        <div class="card-img-overlay d-flex flex-column justify-content-end">
                                            <h5 class="card-title"><?php echo htmlspecialchars($chunk_recipe['title']); ?></h5>
                                            <p class="card-text"><?php echo htmlspecialchars($chunk_recipe['description']); ?></p>
                                        </div>
    ...
    <section class="course m-4">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <!-- How access a variable -->
                <!-- <?php echo htmlspecialchars($popular_course['what_value_you_need']); ?> -->
    ...
    <section class="best-recipe m-4">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <!-- How access a variable -->
                <!-- <?php echo htmlspecialchars($best_recipe['what_value_you_need']); ?> -->

                <?php foreach ($best_recipes as $best_recipe) { ?>
    ...
    <section class="all-categories m-5">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-6 g-4">
                ...
                <!-- How access a variable -->
                <!-- <?php echo htmlspecialchars($categorie['what_value_you_need']); ?> -->
    ...
    <section class="Latest Recipe m-4">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <!-- How access a variable -->
                <!-- <?php echo htmlspecialchars($latest_recipe['what_value_you_need']); ?> -->
