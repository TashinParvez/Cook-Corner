...
<div class="container">
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="../Images\logo\cook_Corner_LOGO-removebg-mainPartOnly.png" alt="" width="72" height="57">
      <h2>Checkout form</h2>
      ...
      <div class="col-md-5 col-lg-4 order-md-last">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            ...
            <span class="text-body-secondary">Tk100</span>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
          ...
          <li class="list-group-item d-flex justify-content-between bg-body-tertiary">
            ...
            <span class="text-success">−Tk100</span>
          </li>
        ...
        <!-- <form class="needs-validation" novalidate> -->
          ...
          <div class="my-3">
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="paypal">Bkash</label>
            </div>
          </div>
          ...
          <button class="btn btn-primary btn-lg btn-block" type="submit" id="sslczPayBtn"
                        postdata="{}"
                        order="123"
